...
//        final String authorization = "access-token";
...
//        when(mockOrderService.saveOrder(orderEntity, saveOrderRequest.getCouponId().toString(), saveOrderRequest.getAddressId().toString(), orderItemEntity, itemEntity, saveOrderRequest.getPaymentId().toString(), saveOrderRequest.getRestaurantId().toString(), authorization))).thenReturn(orderEntity);
...
//        verify(mockOrderService, times(1)).saveOrder(orderEntity, saveOrderRequest.getCouponId().toString(), saveOrderRequest.getAddressId().toString(), orderItemEntity, itemEntity, saveOrderRequest.getPaymentId().toString(), saveOrderRequest.getRestaurantId().toString(), authorization);
...
//        verify(mockOrderService, times(0)).saveOrder(orderEntity, saveOrderRequest.getCouponId().toString(), saveOrderRequest.getAddressId().toString(), orderItemEntity, itemEntity, saveOrderRequest.getPaymentId().toString(), saveOrderRequest.getRestaurantId().toString(), authorization);
...
//        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(), orderEntity.getAddressEntity().getState().getUuid());
//
